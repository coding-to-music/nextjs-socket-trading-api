...
export default function CryptoMarket() {
  ...
  return (
    ...
    >
        ...
        {listings.map((crypto_data) => (
          ...
          >
            <CryptoTab
              ...
              img="./crypto-broker.jpeg"
              price={crypto_data.quote}
              circ_supply={crypto_data.circulating_supply}
              total_supply={crypto_data.total_supply}
              cmc_rank={crypto_data.cmc_rank}
              platforms={crypto_data.platforms}
      ...
      {chosenCrypto ? <CryptoModule data={chosenCryptoData} /> : <></>}
    </div>
  );
}
